...
public class StepTracker {
    ...
    void saveSteps(Scanner scanner) {
        ...
        if(!isMonthInput&&isYes(scanner)){
            ...
            if (month == 0 && day == 1){
                System.out.println("!Ввод количества шагов за 1-е января сбросит значения за весь год!");
                System.out.println("Выйти в главное меню без сохранения количества шагов?");
    ...
    void resetYear(int[][] daySteps) {
        //сбросим значение за год воизбежание накладок
...
void showStatistics(Scanner scanner){
    ...
    System.out.println( "Пройденная дистанция (в км): " + converter.convertToKm(daySteps, month));
